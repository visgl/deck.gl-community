...
import {GeoArrowSolidPolygonLayer} from './geo-arrow-solid-polygon-layer';
import {GeoArrowPathLayer} from './geo-arrow-path-layer';
 ...
 */
export function getPolygonExterior(input: ga.vector.PolygonVector): ga.vector.MultiLineStringVector;
export function getPolygonExterior(input: ga.data.PolygonData): ga.data.MultiLineStringData;
...
export type GeoArrowPolygonLayerProps = Omit<
  PolygonLayerProps,
  'data' | 'getPolygon' | 'getFillColor' | 'getLineColor' | 'getLineWidth' | 'getElevation'
> &
...
export class GeoArrowPolygonLayer<ExtraProps extends {} = {}> extends CompositeLayer<
  Required<GeoArrowPolygonLayerProps> & ExtraProps
> {
