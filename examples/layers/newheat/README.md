...
An interactive, synthetic circuit comparing NewHeatLayer with TripsLayer over
...
```sh
yarn
yarn workspace @deck.gl-community/example-newheat start-local
```
...
2D: TerrainExtension supplies a GPU height map, and NewHeatLayer samples each
