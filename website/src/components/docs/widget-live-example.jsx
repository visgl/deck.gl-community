...
function WidgetLiveExampleHost({highlight, height}) {
...
export default function WidgetLiveExample({highlight, size = 'narrow', height}) {
  ...
  return (
    <BrowserOnly fallback={<div style={{...WRAPPER_STYLE, height: resolvedHeight}} />}>
      {() => <WidgetLiveExampleHost highlight={highlight} height={resolvedHeight} />}
    </BrowserOnly>
  );
}
