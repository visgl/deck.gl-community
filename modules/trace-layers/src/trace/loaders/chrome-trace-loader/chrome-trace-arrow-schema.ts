...
export type ChromeTraceEventArrowColumns = {
  /** Event name from the Chrome trace row. */
  name: arrow.Utf8;
  ...
  tid: arrow.Utf8;
  /** Optional event category label. */
  cat: arrow.Utf8;
  /** Optional duration in the source file's declared time unit. */
  dur: arrow.Float64;
  ...
  scope: arrow.Utf8;
  /** Optional JSON-encoded event args payload. */
  args: arrow.Utf8;
  /** Optional JSON-encoded passthrough payload for unmodeled fields. */
