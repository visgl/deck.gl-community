...
import ColumnGeometry from './experimental-column-geometry';

import {columnUniforms, ColumnProps} from './experimental-column-layer-uniforms';
import vs from './experimental-column-layer-vertex.glsl';
import fs from './experimental-column-layer-fragment.glsl';
...
const defaultProps: DefaultProps<ExperimentalColumnLayerProps> = {
...
/** All properties supported by ExperimentalColumnLayer. */
export type ExperimentalColumnLayerProps<DataT = unknown> = _ExperimentalColumnLayerProps<DataT> & LayerProps;

/** Properties added by ExperimentalColumnLayer. */
type _ExperimentalColumnLayerProps<DataT> = {
