...
/** Parameters used by {@link Tile2DHeader2.loadData}. */
export type Tile2DLoadDataProps<DataT = any> = {
  ...
  onLoad: (tile: Tile2DHeader2<DataT>) => void;
  /** Callback fired after tile content fails to load. */
  onError: (error: any, tile: Tile2DHeader2<DataT>) => void;
};

/** Shared tile cache entry used by {@link Tile2DTileset}. */
export class Tile2DHeader2<DataT = any> {
  /** x/y/z tile coordinate. */
  index: TileIndex;
  /** Closest cached ancestor tile in the current tree. */
  parent: Tile2DHeader2 | null;
  /** Cached child tiles beneath this tile. */
  children: Tile2DHeader2[] | null;
  /** Loaded tile payload. */
  content: DataT | null;
