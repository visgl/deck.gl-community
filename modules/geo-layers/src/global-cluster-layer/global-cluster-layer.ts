...
const defaultProps: DefaultProps<GlobalClusterLayerProps> = {
...
export type GlobalClusterLayerProps = _GlobalClusterLayerProps & LayerProps;

type _GlobalClusterLayerProps = {
  data: ClusterData[];
...
export default class GlobalClusterLayer extends CompositeLayer<GlobalClusterLayerProps> {
