...
import type {ToastEntry, ToastKind} from '../lib/toasts/toast-manager';
...
function ToastComponentView({toasts, showBorder}: ToastComponentViewProps) {
  return (
    <div
...
export class ToastComponent extends PanelComponent<ToastComponentProps> {
  ...
  onAdd() {
    ...
    this.#unsubscriber = toastManager.subscribe(toasts => {
      ...
      if (this.#rootElement) {
        render(
          <ToastComponentView toasts={this.#toasts} showBorder={this.showBorder} />,
          this.#rootElement
        );
      }
    });
  ...
  onRenderHTML(rootElement: HTMLElement): void {
    ...
    render(<ToastComponentView toasts={this.#toasts} showBorder={this.showBorder} />, rootElement);
  }
}
