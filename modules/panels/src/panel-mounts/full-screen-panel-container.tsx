...
/**
 * Props for {@link FullScreenPanelContainer}.
 */
export type FullScreenPanelContainerProps = PanelContainerProps & {
...
function FullScreenPanelContainerView({
  panel,
  title,
  marginPx
}: {
...
export class FullScreenPanelContainer extends PanelContainer<FullScreenPanelContainerProps> {
  ...
  constructor(props: Partial<FullScreenPanelContainerProps> = {}) {
    super({
      ...
      ...props
    } as FullScreenPanelContainerProps);
