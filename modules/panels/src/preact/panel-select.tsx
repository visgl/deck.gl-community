...
export type PanelMultiSelectProps = {
  /** Optional control id used by labels and stable listbox ids. */
  id?: string;
  /** Accessible control label. */
  ariaLabel: string;
  ...
  /** Optional text size applied to the trigger, search, options, and actions. */
...
export function PanelMultiSelect({
  ...
  const listboxId = `${id ?? ariaLabel.toLowerCase().replace(/[^a-z0-9]+/g, '-')}-options`;
        ...
        ? createPortal(
            ...
            >
              <input
                ...
                placeholder="Search..."
                style={{
                  ...PANEL_SELECT_STYLES.searchInput,
                  ...(fontSize === undefined ? {} : {fontSize})
                }}
              ...
              {filteredOptions.length === 0 ? (
                <div
                  style={{
                    ...PANEL_SELECT_STYLES.emptyState,
                    ...(fontSize === undefined ? {} : {fontSize})
                  }}
                >
                  No matching options
              ...
              {selectedValues.length > 0 ? (
                <button
                  type="button"
                  style={{
                    ...PANEL_SELECT_STYLES.clearButton,
                    ...(fontSize === undefined ? {} : {fontSize})
                  }}
                  onMouseDown={event => {
                    event.preventDefault();
