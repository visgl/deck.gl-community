...
import SAMPLE_NODE from '../data/__fixtures__/edge.json';
...
describe('core/node', () => {
  ...
  it.skip('should work for directed', () => {
    ...
    expect([edges2[0], edges2[1]]).toEqual(expect.arrayContaining(node.getConnectedEdges()));
  });
  ...
  it.skip('should have working getters and setters', () => {
    ...
    // test getters
    expect(['node2', 'node3']).toEqual(expect.arrayContaining(node.getSiblingIds()));
