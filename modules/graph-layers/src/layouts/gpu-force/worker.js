...
if (workerScope && typeof workerScope.importScripts === 'function') {
  workerScope.importScripts('https://cdn.jsdelivr.net/npm/gpu.js@latest/dist/gpu-browser.js');
}
...
if (typeof globalThis !== 'undefined') {
  Object.defineProperty(globalThis, '__GPU_FORCE_WORKER_TEST__', {
    value: {
      forceCollide,
      forceLink
    },
