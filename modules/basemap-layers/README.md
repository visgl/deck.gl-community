...
The runtime API is exported from `@deck.gl-community/basemap-layers`, and the pure
style helpers are exported from `@deck.gl-community/basemap-layers/style-spec`.
