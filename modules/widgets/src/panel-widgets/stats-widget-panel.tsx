...
/** Props for {@link StatsWidgetPanel}. */
export type StatsWidgetPanelProps = {
...
export class StatsWidgetPanel implements WidgetPanel {
  /** Stable panel id used by parent containers. */
  id: string;
  /** Visible heading text for the panel. */
  title: string;
  ...
  constructor(props: StatsWidgetPanelProps) {
    this.id = props.id;
    this.title = props.title;
    this.theme = props.theme ?? 'inherit';
    this.content = <StatsWidgetPanelContent {...props} />;
  }
}

/** Renders the stats rows used by {@link StatsWidgetPanel}. */
function StatsWidgetPanelContent({
  stats,
  statNames,
  labels,
  className
}: StatsWidgetPanelProps): JSX.Element {
