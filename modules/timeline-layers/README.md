...
Experimental timeline visualization layers for [deck.gl](https://deck.gl), including HorizonGraph primitives for compact time series displays.
...
Layers originally developed under `@deck.gl-community/infovis-layers` that focus on rendering compact timelines.
