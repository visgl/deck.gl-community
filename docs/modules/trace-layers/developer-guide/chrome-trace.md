...
Read [ChromeTrace](../api-reference/chrome-trace.md) for the exported parser/writer contracts and
[TraceStreamSession](../api-reference/trace-stream-session.md) for the streaming runtime.
